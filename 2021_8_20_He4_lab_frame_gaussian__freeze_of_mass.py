# -*- coding: utf-8 -*-
"""LAB_frame_He4_Nucleus(Gaussian__freeze_of_mass).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1noyO9i7SAO07rY3llTM-PWpogK8Nn7A6
"""
...
ground_state = NeuralWavefunction(3, initial_containment1 = 0.01, initial_containment2 = 0.01)
...
class HydrogenAtom(object):
    ...
    def compute_energies(self, inputs, logw_of_x, dlogw_dx, d2logw_dx2):
        ...
        pe = self.potential_energy(inputs=inputs, Z=2)
...
ax_denst3 = plt.subplot(gs[0:,3], projection="3d")
ax_denst4 = plt.subplot(gs[0:,3], projection="3d")
...
for i in range(1000):
    ...
    view_wolker1 = tf.split(ground_x, npart, axis=(1))[0]
...
# 곂쳐서 봐보기
    view_wolker2 = tf.split(ground_x, npart, axis=(1))[1]
    ...
    view_wolker3 = tf.split(ground_x, npart, axis=(1))[2]
    view_wolker3 = tf.reduce_sum(view_wolker3, axis=(1))
    x3, y3, z3 = tf.split(view_wolker3, 3, axis=1)
    ax_denst3.clear()
    ax_denst3.set_xlim(-4,4); ax_denst3.set_ylim(-4,4); ax_denst3.set_zlim(-4,4);
    ax_denst3.set_xlabel("X3"); ax_denst3.set_ylabel("Y3"); ax_denst3.set_zlabel("Z3");
    ax_denst3.scatter(x1, y1, z1, linewidth=0.5);
    ax_denst3.scatter(x2, y2, z2, linewidth=0.5);
    ax_denst3.scatter(x3, y3, z3, linewidth=0.5);

    view_wolker4 = tf.split(ground_x, npart, axis=(1))[3]
    view_wolker4 = tf.reduce_sum(view_wolker4, axis=(1))
    x4, y4, z4 = tf.split(view_wolker4, 3, axis=1)
    ax_denst4.clear()
    ax_denst4.set_xlim(-4,4); ax_denst4.set_ylim(-4,4); ax_denst4.set_zlim(-4,4);
    ax_denst4.set_xlabel("X4"); ax_denst4.set_ylabel("Y4"); ax_denst4.set_zlabel("Z4");
    ax_denst4.scatter(x1, y1, z1, linewidth=0.5);
    ax_denst4.scatter(x2, y2, z2, linewidth=0.5);
    ax_denst4.scatter(x3, y3, z3, linewidth=0.5);
    ax_denst4.scatter(x4, y4, z4, linewidth=0.5);
